...
class SplitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create split" do
    assert_difference('Split.count') do
      post splits_url, params: { split: { approved: @split.approved, availability_id: @split.availability_id, cancelled: @split.cancelled, user_id: @split.user_id } }
    end
  ...
  test "should update split" do
    patch split_url(@split), params: { split: { approved: @split.approved, availability_id: @split.availability_id, cancelled: @split.cancelled, user_id: @split.user_id } }
